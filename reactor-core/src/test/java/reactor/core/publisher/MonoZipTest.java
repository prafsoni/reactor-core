...
public class MonoZipTest {
	...
	public void whenMonoJust() {
		MonoNextProcessor<Tuple2<Integer, Integer>> mp = MonoNextProcessor.create();
	...
	public void whenMonoJust3() {
		MonoNextProcessor<Tuple3<Integer, Integer, Integer>> mp = MonoNextProcessor.create();
	...
	public void whenMonoJust4() {
		MonoNextProcessor<Tuple4<Integer, Integer, Integer, Integer>> mp =
				MonoNextProcessor.create();
	...
	public void whenMonoJust5() {
		MonoNextProcessor<Tuple5<Integer, Integer, Integer, Integer, Integer>> mp =
				MonoNextProcessor.create();
		StepVerifier.create(Mono.zip(Mono.just(1),
				Mono.just(2),
				Mono.just(3),
	...
	public void whenMonoJust6() {
		MonoNextProcessor<Tuple6<Integer, Integer, Integer, Integer, Integer, Integer>> mp =
				MonoNextProcessor.create();
		StepVerifier.create(Mono.zip(Mono.just(1),
				Mono.just(2),
				Mono.just(3),
	...
	public void whenDelayMonoJust7() {
		MonoNextProcessor<Tuple7<Integer, Integer, Integer, Integer, Integer, Integer, Integer>>
				mp =
				MonoNextProcessor.create();
		StepVerifier.create(Mono.zipDelayError(Mono.just(1),
				Mono.just(2),
